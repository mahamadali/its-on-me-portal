      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="<?php echo base_url('users/store') ?>" enctype="multipart/form-data">
              <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" id="phone" class="form-control" placeholder="Enter Mobile" name="phone" required="">
                </div>
              </div>
              <div class="col-4">
                 <input type="submit" class="btn btn-primary my-4" value="Add User">
                  <a href="<?php echo base_url('users') ?>" class="btn btn-info pull-right">Cancel</a>
                </div>
              </form>
            </div>
          </div>
