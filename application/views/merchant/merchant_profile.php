          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Merchant Profile Detail </h3>
                </div>
                <div class="col-4 text-right">
                  <a href="<?php echo base_url('merchant/list-bank/'.$merchant_data->id) ?>" class="btn btn-sm btn-primary">Bank List</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form method="post" action="<?php echo base_url('merchants/profile_update') ?>" enctype="multipart/form-data">
