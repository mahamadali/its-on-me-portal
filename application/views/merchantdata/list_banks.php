            ...
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="<?php echo base_url('merchant/profile') ?>" class="btn btn-sm btn-primary">Back to Profile</a>
                  <a href="<?php echo base_url('merchant/add-bank/'.$merchant_id) ?>" class="btn btn-sm btn-primary">Add Bank</a>
                </div>
              </div>
            </div>
            <!-- Light table -->
                ...
                <thead class="thead-light">
                 ...
                 <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td >
                      <a href="<?php echo base_url('merchant/delete-merchant-bank') ?>/<?php echo $bank['id'] ?>/<?php echo $bank['merchant_id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                      <a href="<?php echo base_url('merchant/edit-merchant-bank') ?>/<?php echo $bank['id'] ?>/<?php echo $bank['merchant_id'] ?>" class="btn btn-sm btn-primary">Edit</a> 
                    </td>
                  </tr>
                <?php } ?>
